...
void VideoGame::showGame(string filter1, string filter2)
{
    if (filter1 == "Title" || filter2 == "Title")
        cout << "Title: " << title << endl;

    if (filter1 == "Price" || filter2 == "Price")
	    cout << "Price: " << price << " dollars" << endl;

    if (filter1 == "Console" || filter2 == "Console")
    {
        // switch statement to output the right console based upon the char representing the console
        switch (console)
        {
    ...
    if (filter1 == "Release" || filter2 == "Release")
        cout << "Year of Release: " << releaseYear << endl;

    if (filter1 == "Developer" || filter2 == "Developer")
        cout << "Developer: " << developer << endl;

    if (filter1 == "Genre" || filter2 == "Genre")
        cout << "Genre: " << genre << endl;
