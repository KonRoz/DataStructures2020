...
showGame is overloaded. When passed no arguments, the values of all 
7 private members are displayed. When two arguments are passed (i.e.
two filters), the private members to which the two filters correspond
...
class VideoGame
{
	...
	public:
		...
		// additional methods
		void showGame();
        void showGame(string filter1, string filter2);
