...
void VideoGameCollection::partition(VGNode* headl, VGNode** front, VGNode** back)
{
    VGNode* fast;
    VGNode* slow;

    if (headl == NULL || headl->next == NULL)
    {
        *front = headl;
        *back = NULL;
    } else
...
VideoGameCollection::VGNode* VideoGameCollection::mergeListsPrice(VGNode* a, VGNode* b)
{
    VGNode* mergedList = NULL;
    ...
    if (a->videogame.getPrice() <= b->videogame.getPrice())
    {
        mergedList = a;
        mergedList->next = mergeListsPrice(a->next, b);
    } else
    {
        mergedList = b;
        mergedList->next = mergeListsPrice(a, b->next);
    }
    return mergedList;
}

VideoGameCollection::VGNode* VideoGameCollection::mergeListsTitle(VGNode* a, VGNode* b)
{
    VGNode* mergedList = NULL;
    ...
    if (a->videogame.getTitle().compare(b->videogame.getTitle()) < 0)
    {
        mergedList = a;
        mergedList->next = mergeListsTitle(a->next, b);
    } else
    {
        mergedList = b;
        mergedList->next = mergeListsTitle(a, b->next);
    }
    return mergedList;
}

void VideoGameCollection::mergeSortPrice(VGNode** source)
{
    VGNode* head = *source;
    VGNode* a = NULL;
    VGNode* b = NULL;
    ...
    *source = mergeListsPrice(a, b);
}

void VideoGameCollection::mergeSortTitle(VGNode** source)
{
    VGNode* head = *source;
    VGNode* a = NULL;
    VGNode* b = NULL;
    ...
    *source = mergeListsTitle(a, b);
}

void VideoGameCollection::generateTitleSortedList()
{
    mergeSortTitle(&head);
}

void VideoGameCollection::generatePriceSortedList()
{
    mergeSortPrice(&head);
}
