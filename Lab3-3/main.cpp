...
int main()
{
    ...
    while (selected != '9')
    {
        ...
        cout << "7. Generate Title Sorted List\n";
        cout << "8. Generate Price Sorted List\n";
        cout << "9. Exit Program\n";
        ...
        switch (selected)
        {
            ...
            case '7':   myVideoGameCollection.generateTitleSortedList();
                        break;

            case '8':   myVideoGameCollection.generatePriceSortedList();
                        break;
